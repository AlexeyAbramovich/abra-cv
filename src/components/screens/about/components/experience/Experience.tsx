	...
	return (
		<section className={styles.experience}>
			...
			<p>
				...
				знакомства с Ильёй - понял, что пора определиться с чем-то одним и стать
				там экспертом. Он предложил мне изучить HTML, CSS, JS, React и весь
				остальной стек, необходимый для современного Frontend разработчика. Тут
				я принял для себя решение - все погнали, так и начался мой процесс
				обучения.
			</p>
			<Certificates />
		</section>
