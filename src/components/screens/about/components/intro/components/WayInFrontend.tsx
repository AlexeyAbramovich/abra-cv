...
const WayInFrontend = () => {
	return (
		<div className={styles.way_in_frontend}>
			...
			<p>
				Итак поехали, расскажу немного о себе. Кто не понял ещё меня зовут
				Алексей. Как я пришел во Frontend спросите вы? Начиная{' '}
				<span>с декабря 2023 года</span> я активно начал изучать Frontend
				направление. Началось всё с момента, когда я{' '}
				<span>
					познакомился с крутым парнем - Ильёй из компании IT Territory
				</span>
