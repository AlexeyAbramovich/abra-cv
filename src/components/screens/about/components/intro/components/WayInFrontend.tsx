...
const WayInFrontend = () => {
	return (
		<div className={styles.way_in_frontend}>
			...
			<p>
				Итак поехали, расскажу немного о себе. Как я пришел во Frontend спросите
				вы? Начиная <span>с декабря 2023 года</span> я активно начал изучать
				Frontend направление. Началось всё с момента, когда я{' '}
				<span>
